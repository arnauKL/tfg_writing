...
This project has been version controlled since I started it and it is hosted on GitHub. It can be found at #link("https://github.com/arnauKL/codi_tfg")[`arnauKL/tfg`].
// mention sth about the license being MIT?
