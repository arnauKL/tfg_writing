...
The progressive degeneration of dopaminergic neurons in the substantia nigra
pars compacta (SNpc) characterizes PD. These neurons project their axons to the
striatum through the nigrostriatal pathway to regulate voluntary movement.
Because this degeneration is slow and irreversible, substantial damage has
already occurred by the time motor symptoms, such as resting tremor or rigidity,
...
thinning produces only subtle deviations from normal patterns
...
PD against healthy control (HC) patients utilizing DaTscan images. The data are
drawn from the Parkinson's Progression Markers Initiative (PPMI) dataset, which
